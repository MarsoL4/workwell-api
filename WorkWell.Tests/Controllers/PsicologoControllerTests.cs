...
namespace WorkWell.Tests.Controllers
{
    public class PsicologoControllerTests
    {
        ...
        {
            _serviceMock.Setup(x => x.GetAllPagedAsync(1, 10)).ReturnsAsync(new PagedResultDto<PsicologoDto>
            {
                Page = 1,
                PageSize = 10,
                TotalCount = 1
        ...
        public async Task Create_ReturnsCreated()
        {
            ...
            var result = await _controller.Create(new PsicologoDto { Nome = "Psico", Email = "e@e.com", Crp = "1", Ativo = true, SetorId = 1 });
        ...
        {
            var dto = new PsicologoDto { Id = 7, Nome = "Ps", Email = "a", Crp = "b", Ativo = true, SetorId = 2 };
        ...
        {
            var dto = new PsicologoDto { Id = 77, Nome = "Ps", Email = "a", Crp = "b", Ativo = true, SetorId = 2 };
            var result = await _controller.Update(7, dto);
